...
```python
files = armlive_list_files("anxkasacrppihydmaskM1.c1", start, end)
```
...
```python
import act
files = armlive_list_files("anxkasacrppihydmaskM1.c1", "2020-05-31", "2020-05-31")
ds = armlive_open("anxkasacrppihydmaskM1.c1", "2020-05-31", "2020-05-31", cleanup_qc=True)
```
