...
```python
files = armlive_list_files("mos60armlagtrajecmwfM1.c1", start, end)
```
...
```python
import act
files = armlive_list_files("mos60armlagtrajecmwfM1.c1", "2020-01-31", "2020-01-31")
ds = armlive_open("mos60armlagtrajecmwfM1.c1", "2020-01-31", "2020-01-31", cleanup_qc=True)
```
