...
```python
import act
files = armlive_list_files("sgpldquantsC1.c1", "2026-09-20", "2026-09-20")
ds = armlive_open("sgpldquantsC1.c1", "2026-09-20", "2026-09-20", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgpldquantsC1.c1", start, end,
