...
```python
import act
files = armlive_list_files("sgpqcradbrs1longC1.c1", "2026-08-27", "2026-08-27")
ds = armlive_open("sgpqcradbrs1longC1.c1", "2026-08-27", "2026-08-27", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgpqcradbrs1longC1.c1", start, end,
                  keep_variables=['BestEstimate_down_short_hemisp', 'LWdnTc', 'LWdnTd', 'qc_BestEstimate_down_short_hemisp', 'qc_LWdnTc', 'qc_LWdnTd'])
```
