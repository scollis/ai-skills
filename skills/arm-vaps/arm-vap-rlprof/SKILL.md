...
disp.plot("aod", assessment_overplot=True)   # QC-flagged points in red/orange
...
ds = act.io.arm.read_arm_netcdf(files, keep_variables=["asr", "bscat", "ext", "qc_asr", "qc_bscat", "qc_ext"],
                                cleanup_qc=True)
```
...
print(ds["qc_asr"].attrs.get("flag_meanings", "no flag_meanings"))
