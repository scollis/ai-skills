...
avail = requests.get("https://adc.arm.gov/armlive/livedata/query",
                     params={"user": f"{user}:{token}", "ds": "sgpoacomp1zhangC1.c1",
                             "start": "2012-03-21", "end": "2012-03-21", "wt": "json"}).json()
...
ds.qcfilter.datafilter(variables=["time_series_MOOOA", "mass_spectrum_MOOOA", "time_series_LOOOA"],
