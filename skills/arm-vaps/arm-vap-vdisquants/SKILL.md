...
```python
import act
files = armlive_list_files("sgpvdisquantsC1.c1", "2026-09-21", "2026-09-21")
ds = armlive_open("sgpvdisquantsC1.c1", "2026-09-21", "2026-09-21", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgpvdisquantsC1.c1", start, end,
                  keep_variables=['bringi_conv_stra_flag', 'differential_reflectivity_cband20c', 'differential_reflectivity_kaband20c'])
```
