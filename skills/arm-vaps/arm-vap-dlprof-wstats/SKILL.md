...
```python
import act
files = armlive_list_files("sgpdlprofwstats4newsC1.c1", "2025-12-15", "2025-12-15")
ds = armlive_open("sgpdlprofwstats4newsC1.c1", "2025-12-15", "2025-12-15", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgpdlprofwstats4newsC1.c1", start, end,
                  keep_variables=['averaging_time', 'cbw', 'cbw_25'])
```
