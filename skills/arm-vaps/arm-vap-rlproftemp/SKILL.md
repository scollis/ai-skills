...
avail = requests.get("https://adc.arm.gov/armlive/livedata/query",
                     params={"user": f"{user}:{token}", "ds": "sgprlproftemp2news10mC1.c0",
                             "start": "2026-09-18", "end": "2026-09-18", "wt": "json"}).json()
print(avail["num_found"], avail["total_size"])            # files, bytes

# Downloads into ./sgprlproftemp2news10mC1.c0/ unless you pass output=
files = act.discovery.download_arm_data(user, token, "sgprlproftemp2news10mC1.c0", "2026-09-18", "2026-09-18")
ds = act.io.arm.read_arm_netcdf(files, cleanup_qc=True)
print(act.discovery.get_arm_doi("sgprlproftemp2news10mC1.c0", "2026-09-18", "2026-09-18"))   # cite what you pulled
```
