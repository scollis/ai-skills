...
```python
import act
files = armlive_list_files("sgpmfrsrcldod1minC1.c1", "2026-05-03", "2026-05-03")
ds = armlive_open("sgpmfrsrcldod1minC1.c1", "2026-05-03", "2026-05-03", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgpmfrsrcldod1minC1.c1", start, end,
