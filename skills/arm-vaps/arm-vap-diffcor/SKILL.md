...
```python
import act
files = armlive_list_files("sgpbrs1duttC1.c1", "2001-01-19", "2001-01-19")
ds = armlive_open("sgpbrs1duttC1.c1", "2001-01-19", "2001-01-19", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgpbrs1duttC1.c1", start, end,
                  keep_variables=['dsdh_detector_corrected', 'dsdh_full_corrected', 'air_temperature', 'qc_dsdh_detector_corrected', 'qc_dsdh_full_corrected'])
```
