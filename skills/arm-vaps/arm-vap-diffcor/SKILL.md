...
ds = act.io.arm.read_arm_netcdf(files, keep_variables=['dsdh_detector_corrected', 'dsdh_full_corrected', 'air_temperature', 'qc_dsdh_detector_corrected', 'qc_dsdh_full_corrected'],
                                cleanup_qc=True)
```
...
print(ds["qc_dsdh_full_corrected"].attrs["flag_meanings"])
