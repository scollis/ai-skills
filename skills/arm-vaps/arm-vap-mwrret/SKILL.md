...
```python
import act
files = armlive_list_files("sgpmwrret1liljclouC1.c1", "2026-09-15", "2026-09-15")
ds = armlive_open("sgpmwrret1liljclouC1.c1", "2026-09-15", "2026-09-15", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgpmwrret1liljclouC1.c1", start, end,
                  keep_variables=['be_lwp', 'be_pwv', 'cloud_base_height', 'qc_be_lwp', 'qc_be_pwv', 'qc_cloud_base_height'])
```
