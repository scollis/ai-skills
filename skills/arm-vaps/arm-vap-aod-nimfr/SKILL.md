...
```python
import act
files = armlive_list_files("sgpnimfr7nchaod1michC1.c1", "2026-09-19", "2026-09-19")
ds = armlive_open("sgpnimfr7nchaod1michC1.c1", "2026-09-19", "2026-09-19", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgpnimfr7nchaod1michC1.c1", start, end,
                  keep_variables=['Io_filter1', 'Io_filter2', 'Io_filter3', 'qc_Io_filter1', 'qc_Io_filter2', 'qc_Io_filter3'])
```
