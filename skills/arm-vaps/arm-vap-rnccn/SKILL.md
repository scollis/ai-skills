...
```python
import act
files = armlive_list_files("sgprnccnprof1kulkarniC1.c1", "2023-10-14", "2023-10-14")
ds = armlive_open("sgprnccnprof1kulkarniC1.c1", "2023-10-14", "2023-10-14", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgprnccnprof1kulkarniC1.c1", start, end,
                  keep_variables=['ccn_1', 'ccn_2', 'ccn_3', 'qc_ccn_1', 'qc_ccn_2', 'qc_ccn_3'])
```
