...
```python
import act
files = armlive_list_files("sgp30smplcmask1zwangC1.c1", "2026-09-20", "2026-09-20")
ds = armlive_open("sgp30smplcmask1zwangC1.c1", "2026-09-20", "2026-09-20", cleanup_qc=True)
```
