...
disp.plot("downwelling_shortwave", assessment_overplot=True)   # QC-flagged points in red/orange
...
ds = act.io.arm.read_arm_netcdf(files, keep_variables=["downwelling_shortwave", "downwelling_longwave", "upwelling_shortwave", "qc_downwelling_shortwave", "qc_downwelling_longwave", "qc_upwelling_shortwave"],
                                cleanup_qc=True)
```
...
print(ds["qc_downwelling_shortwave"].attrs.get("flag_meanings", "no flag_meanings"))
