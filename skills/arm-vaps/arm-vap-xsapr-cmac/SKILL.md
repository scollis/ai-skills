...
```python
files = armlive_list_files("nsaxsaprcmacppiC1.c1", start, end)
```
...
```python
import act
files = armlive_list_files("nsaxsaprcmacppiC1.c1", "2020-09-24", "2020-09-24")
ds = armlive_open("nsaxsaprcmacppiC1.c1", "2020-09-24", "2020-09-24", cleanup_qc=True)
```
