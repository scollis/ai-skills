...
```python
import act
files = armlive_list_files("sgpacsmcdceC1.c1", "2016-12-22", "2016-12-22")
ds = armlive_open("sgpacsmcdceC1.c1", "2016-12-22", "2016-12-22", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgpacsmcdceC1.c1", start, end,
                  keep_variables=['CDCE', 'acsm_vol_conc', 'acsm_vol_conc_CDCE', 'qc_CDCE', 'qc_acsm_vol_conc', 'qc_acsm_vol_conc_CDCE'])
```
