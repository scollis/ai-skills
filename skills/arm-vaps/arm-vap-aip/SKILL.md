...
```python
import act
files = armlive_list_files("sgpaipavg1ogrenC1.c1", "2017-03-27", "2017-03-27")
ds = armlive_open("sgpaipavg1ogrenC1.c1", "2017-03-27", "2017-03-27", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgpaipavg1ogrenC1.c1", start, end,
                  keep_variables=['Ba_B_Dry_10um_PSAP3W_1', 'Ba_B_Dry_1um_PSAP3W_1', 'Ba_G_Dry_10um_PSAP1W_1', 'qc_Ba_B_Dry_10um_PSAP3W_1', 'qc_Ba_B_Dry_1um_PSAP3W_1', 'qc_Ba_G_Dry_10um_PSAP1W_1'])
```
