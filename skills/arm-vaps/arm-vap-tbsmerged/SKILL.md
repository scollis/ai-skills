...
```python
import act
files = armlive_list_files("sgptbsmergedC1.c1", "2024-11-11", "2024-11-11")
ds = armlive_open("sgptbsmergedC1.c1", "2024-11-11", "2024-11-11", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgptbsmergedC1.c1", start, end,
                  keep_variables=['bl_height_1', 'bl_height_2', 'bl_height_3', 'qc_bl_height_1', 'qc_bl_height_2', 'qc_bl_height_3'])
```
