...
```python
import act
files = armlive_list_files("sgpxsaprmmcgI5.c1", "2019-03-31", "2019-03-31")
ds = armlive_open("sgpxsaprmmcgI5.c1", "2019-03-31", "2019-03-31", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgpxsaprmmcgI5.c1", start, end,
                  keep_variables=['ROI', 'SNR', 'corrected_differential_phase'])
```
