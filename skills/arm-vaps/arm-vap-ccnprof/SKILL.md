...
```python
import act
files = armlive_list_files("sgprlccnprof1ghanC1.c1", "2014-06-24", "2014-06-24")
ds = armlive_open("sgprlccnprof1ghanC1.c1", "2014-06-24", "2014-06-24", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgprlccnprof1ghanC1.c1", start, end,
                  keep_variables=['CCN_ss_calc', 'CCN_ss_set', 'N_CCN_1', 'qc_CCN_ss_calc', 'qc_CCN_ss_set', 'qc_N_CCN_1'])
```
