...
disp.plot("radar_precip_mean", assessment_overplot=True)   # QC-flagged points in red/orange
...
ds = act.io.arm.read_arm_netcdf(files, keep_variables=["cloud_phase_mplgr", "cloud_phase_hsrl", "mpl_b", "qc_cloud_phase_mplgr", "qc_cloud_phase_hsrl", "qc_mpl_b"],
                                cleanup_qc=True)
```
...
print(ds["qc_cloud_phase_mplgr"].attrs.get("flag_meanings", "no flag_meanings"))
