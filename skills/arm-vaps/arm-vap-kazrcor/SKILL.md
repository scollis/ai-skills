...
```python
files = armlive_list_files("sgpkazrcormdC1.c1", start, end)
```
...
```python
import act
files = armlive_list_files("sgpkazrcormdC1.c1", "2019-12-20", "2019-12-20")
ds = armlive_open("sgpkazrcormdC1.c1", "2019-12-20", "2019-12-20", cleanup_qc=True)
```
