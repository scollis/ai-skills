...
avail = requests.get("https://adc.arm.gov/armlive/livedata/query",
                     params={"user": f"{user}:{token}", "ds": "sgpaerosolbe1turnC1.c1",
                             "start": "2021-04-01", "end": "2021-04-01", "wt": "json"}).json()
...
ds.qcfilter.datafilter(variables=["be_aod_500", "be_aod_355", "be_angstrom_exponent"],
