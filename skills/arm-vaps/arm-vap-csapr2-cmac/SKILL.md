...
```python
import act
files = armlive_list_files("houcsapr2cmacS2.c1", "2022-09-28", "2022-09-28")
ds = armlive_open("houcsapr2cmacS2.c1", "2022-09-28", "2022-09-28", cleanup_qc=True)
```
...
```python
ds = armlive_open("houcsapr2cmacS2.c1", start, end,
