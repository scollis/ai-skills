...
```python
import act
files = armlive_list_files("sgparealavealbC1.c1", "2022-06-25", "2022-06-25")
ds = armlive_open("sgparealavealbC1.c1", "2022-06-25", "2022-06-25", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgparealavealbC1.c1", start, end,
                  keep_variables=['areal_ave_surface_albedo', 'areal_daily_ave_surface_albedo', 'cloud_base_best_estimate', 'qc_areal_ave_surface_albedo', 'qc_areal_daily_ave_surface_albedo', 'qc_cloud_base_best_estimate'])
```
