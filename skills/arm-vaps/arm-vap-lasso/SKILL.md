...
```python
files = armlive_list_files("sgplassohighfreqobsC1.c1", start, end)
```
...
```python
import act
files = armlive_list_files("sgplassohighfreqobsC1.c1", "2026-09-24", "2026-09-24")
ds = armlive_open("sgplassohighfreqobsC1.c1", "2026-09-24", "2026-09-24", cleanup_qc=True)
```
