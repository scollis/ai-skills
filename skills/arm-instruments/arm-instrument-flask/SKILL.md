...
```python
import act
files = armlive_list_files("sgpghgisoflaskC1.b1", "2024-09-01", "2024-09-01")
ds = armlive_open("sgpghgisoflaskC1.b1", "2024-09-01", "2024-09-01", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgpghgisoflaskC1.b1", start, end,
                  keep_variables=["C2Br2F4", "C2Cl4", "C2H2", "qc_C2Br2F4", "qc_C2Cl4", "qc_C2H2"])
```
