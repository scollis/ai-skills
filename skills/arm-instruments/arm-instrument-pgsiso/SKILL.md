...
```python
import act
files = armlive_list_files("sgppgsisocoeffC1.b1", "2023-04-19", "2023-04-19")
ds = armlive_open("sgppgsisocoeffC1.b1", "2023-04-19", "2023-04-19", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgppgsisocoeffC1.b1", start, end,
                  keep_variables=["ch4_gain", "ch4_offset", "co2_12_gain", "qc_ch4_gain", "qc_ch4_offset", "qc_co2_12_gain"])
```
