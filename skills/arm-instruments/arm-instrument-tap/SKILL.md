...
avail = requests.get("https://adc.arm.gov/armlive/livedata/query",
                     params={"user": f"{user}:{token}", "ds": "sgpaostapE13.b1",
                             "start": "2018-04-14", "end": "2018-04-14", "wt": "json"}).json()
...
ds.qcfilter.datafilter(variables=["transmittance_blue", "transmittance_green", "transmittance_red"],
