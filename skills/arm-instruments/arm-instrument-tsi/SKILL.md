...
```python
import act
files = armlive_list_files("sgptsiskycoverC1.b1", "2025-08-18", "2025-08-18")
ds = armlive_open("sgptsiskycoverC1.b1", "2025-08-18", "2025-08-18", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgptsiskycoverC1.b1", start, end,
                  keep_variables=["count_box", "count_mask", "count_opaque", "qc_count_box", "qc_count_mask", "qc_count_opaque"])
```
