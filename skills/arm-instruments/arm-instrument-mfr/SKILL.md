...
disp.plot("up_hemisp_narrowband_filter1", assessment_overplot=True)   # QC-flagged points in red/orange
...
ds = act.io.arm.read_arm_netcdf(files, keep_variables=["up_hemisp_narrowband_filter1", "up_hemisp_narrowband_filter2", "up_hemisp_narrowband_filter3", "qc_up_hemisp_narrowband_filter1", "qc_up_hemisp_narrowband_filter2", "qc_up_hemisp_narrowband_filter3"],
                                cleanup_qc=True)
```
...
print(ds["qc_up_hemisp_narrowband_filter1"].attrs.get("flag_meanings", "no flag_meanings"))
