...
```python
import act
files = armlive_list_files("sgpmfr7nch25mC1.b1", "2026-09-20", "2026-09-20")
ds = armlive_open("sgpmfr7nch25mC1.b1", "2026-09-20", "2026-09-20", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgpmfr7nch25mC1.b1", start, end,
                  keep_variables=["head_temp", "head_temp2", "logger_temperature", "qc_head_temp", "qc_head_temp2", "qc_logger_temperature"])
```
