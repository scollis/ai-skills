...
```python
import act
files = armlive_list_files("houxsacrcfrqcM1.b1", "2022-09-18", "2022-09-18")
ds = armlive_open("houxsacrcfrqcM1.b1", "2022-09-18", "2022-09-18", cleanup_qc=True)
```
...
```python
ds = armlive_open("houxsacrcfrqcM1.b1", start, end,
                  keep_variables=["altitude_agl", "antenna_transition", "attenuation_corrected_differential_reflectivity"])
```
