...
```python
import act
files = armlive_list_files("enaaafcasF1.b1", "2018-02-18", "2018-02-18")
ds = armlive_open("enaaafcasF1.b1", "2018-02-18", "2018-02-18", cleanup_qc=True)
```
...
```python
ds = armlive_open("enaaafcasF1.b1", start, end,
                  keep_variables=["counts", "laser_current", "back_block_temperature", "qc_counts", "qc_laser_current"])
```
