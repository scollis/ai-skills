...
avail = requests.get("https://adc.arm.gov/armlive/livedata/query",
                     params={"user": f"{user}:{token}", "ds": "magassistsummaryM1.b1",
                             "start": "2012-12-07", "end": "2012-12-07", "wt": "json"}).json()
...
ds.qcfilter.datafilter(variables=["ch1_surface_layer_radiance", "ch1_elevated_layer_radiance", "ch1_window_radiance"],
