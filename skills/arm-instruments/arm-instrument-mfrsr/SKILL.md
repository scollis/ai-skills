...
ds = act.io.arm.read_arm_netcdf(files, keep_variables=["alltime_hemisp_narrowband_filter1", "alltime_hemisp_narrowband_filter2", "alltime_hemisp_narrowband_filter3", "qc_alltime_hemisp_narrowband_filter1", "qc_alltime_hemisp_narrowband_filter2", "qc_alltime_hemisp_narrowband_filter3"],
                                cleanup_qc=True)
```
...
print(ds["qc_hemisp_narrowband_filter1"].attrs["flag_meanings"])
