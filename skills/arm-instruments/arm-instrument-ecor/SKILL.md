...
ds = act.io.arm.read_arm_netcdf(files, keep_variables=["air_density", "air_heat_capacity", "air_pressure", "qc_air_density", "qc_air_heat_capacity", "qc_air_pressure"],
                                cleanup_qc=True)
```
...
print(ds["qc_momentum_flux"].attrs["flag_meanings"])
