...
avail = requests.get("https://adc.arm.gov/armlive/livedata/query",
                     params={"user": f"{user}:{token}", "ds": "enaaoshtdmaC1.b1",
                             "start": "2023-05-21", "end": "2023-05-21", "wt": "json"}).json()
...
ds.qcfilter.datafilter(variables=["dry_diameter_setting", "dry_pressure", "dry_temperature"],
