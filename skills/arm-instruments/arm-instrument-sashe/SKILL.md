...
```python
import act
files = armlive_list_files("sgpsashevisC1.b1", "2024-05-31", "2024-05-31")
ds = armlive_open("sgpsashevisC1.b1", "2024-05-31", "2024-05-31", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgpsashevisC1.b1", start, end,
                  keep_variables=["ad_temperature_vis", "airmass", "atmos_pressure", "qc_ad_temperature_vis", "qc_airmass", "qc_atmos_pressure"])
```
