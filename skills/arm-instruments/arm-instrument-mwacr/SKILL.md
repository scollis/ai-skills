...
```python
import act
files = armlive_list_files("kcgmwacrcfrqcM1.b1", "2025-04-27", "2025-04-27")
ds = armlive_open("kcgmwacrcfrqcM1.b1", "2025-04-27", "2025-04-27", cleanup_qc=True)
```
...
```python
ds = armlive_open("kcgmwacrcfrqcM1.b1", start, end,
                  keep_variables=["altitude_agl", "azimuth", "censor_mask"])
```
