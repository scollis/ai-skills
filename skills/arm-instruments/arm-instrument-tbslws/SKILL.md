...
```python
files = armlive_list_files("olitbslwsM1.a0", start, end)
```
...
```python
import act
files = armlive_list_files("olitbslwsM1.a0", "YYYY-MM-DD", "YYYY-MM-DD")
ds = armlive_open("olitbslwsM1.a0", "YYYY-MM-DD", "YYYY-MM-DD", cleanup_qc=True)
```
