...
avail = requests.get("https://adc.arm.gov/armlive/livedata/query",
                     params={"user": f"{user}:{token}", "ds": "sgpcfhC1.b1",
                             "start": "2019-12-18", "end": "2019-12-18", "wt": "json"}).json()
...
ds.qcfilter.datafilter(variables=["data_frame_number", "pressure", "temperature"],
