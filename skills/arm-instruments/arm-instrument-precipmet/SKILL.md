...
avail = requests.get("https://adc.arm.gov/armlive/livedata/query",
                     params={"user": f"{user}:{token}", "ds": "sgpprecipmetI9.b1",
                             "start": "2023-09-26", "end": "2023-09-26", "wt": "json"}).json()
print(avail["num_found"], avail["total_size"])            # files, bytes

# Downloads into ./sgpprecipmetI9.b1/ unless you pass output=
files = act.discovery.download_arm_data(user, token, "sgpprecipmetI9.b1", "2023-09-26", "2023-09-26")
ds = act.io.arm.read_arm_netcdf(files, cleanup_qc=True)
print(act.discovery.get_arm_doi("sgpprecipmetI9.b1", "2023-09-26", "2023-09-26"))   # cite what you pulled
```
