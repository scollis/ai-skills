...
loadable skills - **128 instruments**, each grounded in the handbook *and* in a real
...
ARM instrument mentors who wrote the handbooks - 123 of the 128 name their
...
128 times - load `act-arm-live` for the service, datastream naming, the server-side
...
122 of the 128 skills were checked against a file that was actually opened. The
other 6 say so in place of a data section, with the reason - aircraft video
...
- Handbook URL patterns probed across all 594 codes on 2026-09-23; 128 handbooks downloaded and text-extracted
- ARM Live queried with `ARMUSER`/`ARMTOKEN` on 2026-09-23; 122 files opened with ACT 2.3.4
