...
```python
import act
files = armlive_list_files("sgpmwr3cC1.b1", "2026-09-19", "2026-09-19")
ds = armlive_open("sgpmwr3cC1.b1", "2026-09-19", "2026-09-19", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgpmwr3cC1.b1", start, end,
                  keep_variables=["ambient_target_sensor_1_temperature", "ambient_target_sensor_2_temperature", "azimuth", "qc_ambient_target_sensor_1_temperature", "qc_ambient_target_sensor_2_temperature", "qc_azimuth"])
```
