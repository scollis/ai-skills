...
```python
files = armlive_list_files("bnfstereocambmovieS10.a1", start, end)
```
...
```python
import act
files = armlive_list_files("bnfstereocambmovieS10.a1", "2026-09-03", "2026-09-03")
ds = armlive_open("bnfstereocambmovieS10.a1", "2026-09-03", "2026-09-03", cleanup_qc=True)
```
