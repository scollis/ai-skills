...
```python
import act
files = armlive_list_files("sgpminimplC1.b1", "2026-07-24", "2026-07-24")
ds = armlive_open("sgpminimplC1.b1", "2026-07-24", "2026-07-24", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgpminimplC1.b1", start, end,
                  keep_variables=["detector_temp", "energy_monitor", "laser_temp", "qc_detector_temp", "qc_energy_monitor", "qc_laser_temp"])
```
