...
disp.plot("detector_temp", assessment_overplot=True)   # QC-flagged points in red/orange
...
ds = act.io.arm.read_arm_netcdf(files, keep_variables=["range_offset", "energy_monitor", "detector_temp", "qc_range_offset", "qc_energy_monitor", "qc_detector_temp"],
                                cleanup_qc=True)
```
...
print(ds["qc_range_offset"].attrs.get("flag_meanings", "no flag_meanings"))
