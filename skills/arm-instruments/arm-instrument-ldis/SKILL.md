...
```python
import act
files = armlive_list_files("sgpldC1.b1", "2026-09-19", "2026-09-19")
ds = armlive_open("sgpldC1.b1", "2026-09-19", "2026-09-19", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgpldC1.b1", start, end,
                  keep_variables=["equivalent_radar_reflectivity_ott", "heating_current", "laserband_amplitude", "qc_equivalent_radar_reflectivity_ott", "qc_heating_current", "qc_laserband_amplitude"])
```
