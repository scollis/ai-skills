...
ds = act.io.arm.read_arm_netcdf(files, keep_variables=["equivalent_radar_reflectivity_ott", "heating_current", "laserband_amplitude", "qc_equivalent_radar_reflectivity_ott", "qc_heating_current", "qc_laserband_amplitude"],
                                cleanup_qc=True)
```
...
print(ds["qc_precip_rate"].attrs["flag_meanings"])
