...
```python
files = armlive_list_files("coraafwcmF1.a1", start, end)
```
...
```python
import act
files = armlive_list_files("coraafwcmF1.a1", "2018-11-04", "2018-11-04")
ds = armlive_open("coraafwcmF1.a1", "2018-11-04", "2018-11-04", cleanup_qc=True)
```
