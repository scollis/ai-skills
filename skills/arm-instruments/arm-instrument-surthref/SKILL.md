...
avail = requests.get("https://adc.arm.gov/armlive/livedata/query",
                     params={"user": f"{user}:{token}", "ds": "sgpsurthrefC1.b1",
                             "start": "2014-09-12", "end": "2014-09-12", "wt": "json"}).json()
...
ds.qcfilter.datafilter(variables=["temp_v1_mean", "temp_v2_mean", "temp_v3_mean"],
