...
avail = requests.get("https://adc.arm.gov/armlive/livedata/query",
                     params={"user": f"{user}:{token}", "ds": "bnfparS14.b1",
                             "start": "2026-09-19", "end": "2026-09-19", "wt": "json"}).json()
print(avail["num_found"], avail["total_size"])            # files, bytes

# Downloads into ./bnfparS14.b1/ unless you pass output=
files = act.discovery.download_arm_data(user, token, "bnfparS14.b1", "2026-09-19", "2026-09-19")
assert files, "nothing transferred - ARM Live rate limits with HTTP 429; retry"
ds = act.io.arm.read_arm_netcdf(files, cleanup_qc=True)
print(act.discovery.get_arm_doi("bnfparS14.b1", "2026-09-19", "2026-09-19"))   # cite what you pulled
```
### First look
...
print(ds["qc_batt_volt_min"].attrs.get("flag_meanings", "no flag_meanings"))
...
ds.qcfilter.datafilter(variables=["batt_volt_min", "rh", "rh_std"],
