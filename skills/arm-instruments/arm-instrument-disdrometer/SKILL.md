...
avail = requests.get("https://adc.arm.gov/armlive/livedata/query",
                     params={"user": f"{user}:{token}", "ds": "sgpdisdrometerC1.b1",
                             "start": "2025-04-05", "end": "2025-04-05", "wt": "json"}).json()
...
ds.qcfilter.datafilter(variables=["precip_dis", "num_drop", "rain_rate"],
