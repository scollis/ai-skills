...
avail = requests.get("https://adc.arm.gov/armlive/livedata/query",
                     params={"user": f"{user}:{token}", "ds": "sgptowermetC1.b1",
...
ds.qcfilter.datafilter(variables=["temperature_SE_25m_avg", "relative_humidity_SE_25m_avg", "vapor_pressure_SE_25m_avg"],
