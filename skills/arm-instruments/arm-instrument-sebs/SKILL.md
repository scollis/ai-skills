...
ds = act.io.arm.read_arm_netcdf(files, keep_variables=["albedo", "battery_voltage", "corr_soil_heat_flow_1", "qc_albedo", "qc_battery_voltage", "qc_corr_soil_heat_flow_1"],
                                cleanup_qc=True)
```
...
print(ds["qc_down_short_hemisp"].attrs["flag_meanings"])
