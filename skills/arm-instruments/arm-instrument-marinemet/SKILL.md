...
avail = requests.get("https://adc.arm.gov/armlive/livedata/query",
                     params={"user": f"{user}:{token}", "ds": "magmarinemet1sM1.b1",
                             "start": "2013-10-06", "end": "2013-10-06", "wt": "json"}).json()
...
ds.qcfilter.datafilter(variables=["wspd_adc", "wdir_adc", "air_temp_adc"],
