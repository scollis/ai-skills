...
```python
import act
files = armlive_list_files("anxsodarM1.b1", "2020-05-29", "2020-05-29")
ds = armlive_open("anxsodarM1.b1", "2020-05-29", "2020-05-29", cleanup_qc=True)
```
