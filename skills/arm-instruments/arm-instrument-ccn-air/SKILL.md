...
```python
import act
files = armlive_list_files("sgpaafccn2colbF1.b1", "2016-09-21", "2016-09-21")
ds = armlive_open("sgpaafccn2colbF1.b1", "2016-09-21", "2016-09-21", cleanup_qc=True)
```
...
```python
ds = armlive_open("sgpaafccn2colbF1.b1", start, end,
                  keep_variables=["N_CCN", "N_CCN_dN", "P_sample", "qc_N_CCN"])
```
