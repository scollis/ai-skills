...
avail = requests.get("https://adc.arm.gov/armlive/livedata/query",
                     params={"user": f"{user}:{token}", "ds": "shbgpsC1.a1",
                             "start": "1998-10-01", "end": "1998-10-01", "wt": "json"}).json()
print(avail["num_found"], avail["total_size"])            # files, bytes

# Downloads into ./shbgpsC1.a1/ unless you pass output=
files = act.discovery.download_arm_data(user, token, "shbgpsC1.a1", "1998-10-01", "1998-10-01")
assert files, "nothing transferred - ARM Live rate limits with HTTP 429; retry"
ds = act.io.arm.read_arm_netcdf(files, cleanup_qc=True)
print(act.discovery.get_arm_doi("shbgpsC1.a1", "1998-10-01", "1998-10-01"))   # cite what you pulled
```
### First look
